-- Cria schema do capitulo 03 do curso
DROP SCHEMA IF EXISTS "cap03" ;

CREATE SCHEMA IF NOT EXISTS "cap03"
    AUTHORIZATION "pgAdministrador";


-- Criando a tabela 'estudantes_dsa'
DROP TABLE IF EXISTS cap03.estudantes_dsa;
...
-- Carregando a tabela 'estudantes_dsa'
